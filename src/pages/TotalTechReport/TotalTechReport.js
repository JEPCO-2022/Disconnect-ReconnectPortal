...
const TotalTechReport = () => {
  ...
  const handleChangeRadioGroupTechnicianType = (event) => {
    setValueRBG(event.target.value);
    reportTable.length = 0;
  };
  const handleTab = () => {
                    ...
                    <TableRow>
                      ...
                      {valueRDG === '1' ? (
                        <>
                          ...
                          <StyledTableCell align="center"> عدد العدادات الموصولة كاملة </StyledTableCell>
                        </>
                      ) : (
                        <>
                          ...
                          <StyledTableCell align="center"> العدادات المفصولة كاملة </StyledTableCell>
                        </>
                      )}
                    </TableRow>
                  </TableHead>
...
export default TotalTechReport;
